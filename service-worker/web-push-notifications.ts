...
import { closeDatabaseConnections, createNotificationOptions, findNotification } from './notification'
...
function isClientFocused() {
    return self.clients.matchAll({ type: 'window', includeUncontrolled: true }).then(windowClients => Promise.resolve(windowClients.some(windowClient => windowClient.focused)))
}
