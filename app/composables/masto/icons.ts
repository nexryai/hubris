// @unocss-include
export const accountFieldIcons: Record<string, string> = Object.fromEntries(
    Object.entries({
...
const accountFieldIconsLowercase = Object.fromEntries(Object.entries(accountFieldIcons).map(([k, v]) => [k.toLowerCase(), v]))
